...
export type EthereumWalletSummary = SchemaType<"EthereumWalletSummary">;
export type ZeroGAccountGetParams = SchemaType<"ZeroGAccountGetParams">;
export type ZeroGFundMainParams = SchemaType<"ZeroGFundMainParams">;
export type ZeroGFundProviderParams = SchemaType<"ZeroGFundProviderParams">;
export type ZeroGAcknowledgeProviderParams = SchemaType<"ZeroGAcknowledgeProviderParams">;
export type ZeroGAccountSummary = SchemaType<"ZeroGAccountSummary">;
